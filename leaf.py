...
filepath = 'E:\Projects\Plant-Leaf-Disease-Prediction-main\nabtaaimodel/model.h5'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('E:\Projects\Plant-Leaf-Disease-Prediction-main\nabtaaimodel/static/upload/', filename)
        file.save(file_path)
